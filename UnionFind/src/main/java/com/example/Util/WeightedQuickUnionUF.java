...
public class WeightedQuickUnionUF {
    ...
    public String  imprimirArbol(){
        ...
        Graph graph = new SingleGraph("Cluster de Amistades");
    ...
    public String toString(){
        ...
        String estadoArbol = "-".repeat(10) + "\n";

        estadoArbol += "Parent [ ] = " + java.util.Arrays.toString(parent) + "\n";
        estadoArbol += "Siza [ ] = " + java.util.Arrays.toString(size) + "\n";

        estadoArbol += "-".repeat(10) + "\n";
